...
class _VideoPlayerWidgetState extends State<VideoPlayerWidget> {
  ...
  void initState() {
    ...
    _controller.initialize().then((_) {
      ...
      final isSheetOpen = state is LessonDetailLoaded && state.isSheetOpen;
      setState(() {});
      if (!isSheetOpen) {
        _controller.play();
        _startHideControlsTimer();

        context.read<LessonDetailBloc>().add(VideoPlayPauseToggled());
      }
    });
  }
  ...
  void _onVideoUpdate() {
    ...
    context.read<LessonDetailBloc>().add(VideoPositionChanged(current));
  }
